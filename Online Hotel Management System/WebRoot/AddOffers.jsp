...
<center>
   ...
   <form method="" action="./AddCatBrandOffAction" name="" onSubmit="return validate()"> 
     ...
     <center>  <% if(request.getParameter("status")!=null)
                      ...
                      <%}%></center>
 <tr><td> Offer Name</td><td><input type="text" name="oname"></td></tr> <br>
 <tr><td>  Offer Desc</td><td><input type="text" name="odesc"></td></tr><br>
 <tr><td>  Offer Discount</td><td><input type="text" name="discount">%</td></tr><br>
   

   <tr> <center><td><input type="submit" name="submit" value="Add Offer"></td><td><input type="reset" name="clear" value="Clear"></td></center></tr><br>
