...
<center>
 ...
 <tr><td> Item Name</td><td><input type="text" name="iname"></td></tr>
  ...
  <option value="Abnormal">Abnormal(For BP,Sugar Patient)</option>
  <option value="Normal">Normal</option>
  </select></td></tr> 
  
  <tr><td>  Item Desc</td><td><input type="text" name="idesc"></td></tr>
  
 <tr><td>  Item Cost/Unit</td><td><input type="text" name="icost"></td></tr>
   
<tr><td>  Discount</td><td><input type="text" name="idiscount"></td></tr>
