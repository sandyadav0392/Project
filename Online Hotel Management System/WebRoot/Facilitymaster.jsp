...
<%@page import="com.dts.project.model.HotelModel"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
function inDate(){
  ...
  var date=new Date();
  document.facility.stdate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
<center>
 <form method="" action="./AddItemOrdrBookAction" name="facility" onSubmit="return validate()"> 
 ...
 <tr><td>Facility Name</td><td><input type="text" name="fname"></td></tr>  
 <tr><td> Facility Desc</td><td><input type="file" name="fdesc"></td></tr>
   <tr><td>Start Date</td><td><input type="text" name="stdate" onfocus="inDate()" ></td></tr>
<%--   <tr><td>End Date</td><td><input type="text" name="enddate"></td></tr>--%>


   <tr><td>Aditional Charges</td><td><input type="text" name="aditionalchrg"></td></tr>
     <tr>
...
<% 
CoreHash ch2=new HotelDAO().getHotelNames();
	             Enumeration em2=ch2.elements();
	            
	            HotelModel p2=null;
	             while(em2.hasMoreElements()){
	                   p2=(HotelModel)em2.nextElement();
   ...
   <tr><td><input type="submit" name="submit" value="Add Facility"></td>
