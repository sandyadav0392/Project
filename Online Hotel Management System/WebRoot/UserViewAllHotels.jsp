...
<%@page import="com.dts.project.dao.HotelDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
// --></SCRIPT>
					...
					<DIV id="header">
	<IMG src="images/masthead2.jpg" alt="Telemarketing.com" width="1255" height="104" usemap="#masthead3856a44"><MAP name="masthead3856a44"><AREA shape="rect" coords="5,5,296,80" href="#" alt="Telemarketing.com"></MAP>
...
<table align="center" WIDTH="630" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">View All Hotels</font></center></th>
      <tr rowspan="4"></tr>
  ...
  HotelModel  emodel=null;

       try{
       
        String details=getServletContext().getRealPath("/userimages");
       CoreHash ch=new HotelDAO().getAllHotelDetails();
        Enumeration em=ch.elements();
         
      String report="";
            report+=" <table align='center' WIDTH='630' border='2' bordercolor='black' bgcolor='#F4F5F7'>";
         report+="<th colspan='15' bgcolor='lightgreen'><center><b><font color='white'>View All Hotels</font></center></th>";
      report+="<tr rowspan='4'></tr>";
        ...
        if(request.getParameter("status")!=null)
           ...
           report+="<tr><td>Hotel Name</td><td>Plot</td><td>Street</td><td>City</td><td>State</td><td>Pin</td> <td>Start.Date</td> <td>Incharge Name</td><td>Mail-ID</td> <td>Contact-No</td> </tr> ";  
    ...
    <td>Contact-No</td>
       ...
       <table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="">
        ...
        while(em.hasMoreElements()){
             emodel=(HotelModel)em.nextElement();
           
             
         report+="<tr>";
   report+="<td value="+emodel.getHotelid()+">"+emodel.getHotelname()+"</td>";
  report+=" <td >"+emodel.getHotelpltno() +"</td>";
   report+="<td >"+emodel.getHtlstreet()+"</td>";
   report+=" <td >"+emodel.getHotelcity()+"</td>";
   report+=" <td >"+emodel.getHotelstate()+"</td>";
   report+="<td >"+emodel.getHotelpin()+"</td>";
   report+=" <td >"+emodel.getHotelstdate()+"</td>";   
   report+="<td value="+emodel.getInchrgid()+">"+emodel.getInchrgname()+"</td></tr>";   
    report+=" <td >"+emodel.getHotelmailid()+"</td>";  
    report+=" <td >"+emodel.getContactno()+"</td>";     
       ...
       session.setAttribute("Report",report);     
        ...
        <tr>
 <td value="<%=emodel.getHotelid() %>"><%=emodel.getHotelname() %></td>
  <td ><%=emodel.getHotelpltno() %></td>
   <td ><%=emodel.getHtlstreet() %></td>
   <td ><%=emodel.getHotelcity() %></td>
   <td ><%=emodel.getHotelstate() %></td>
   <td ><%=emodel.getHotelpin() %></td>
   <td ><%=emodel.getHotelstdate() %></td>   
   <td value="<%=emodel.getInchrgid()%>"><%=emodel.getInchrgname() %></td>
    <td ><%=emodel.getHotelmailid() %></td>
    <td ><%=emodel.getContactno() %></td>  
  </tr>
  <%} %>
  </table>
