...
<center>
	...
	<form action="./LoginAction" method="post" name="register" onSubmit="return validate()">
      ...
      <center>  <% if(request.getParameter("status")!=null)
                      ...
                      <%}%></center>
       <table cellpadding="2px" cellspacing="1px" bgcolor="#F4F5F7" width="764" class="tableBorder" align="center" height="288">
    ...
    <tr>
        <td align="center" colspan="2">
            <img src="images/automated2-60.jpg" border="2" align="absbottom" width="100" height="94"/>&nbsp; <font size="4"><strong>
            <span class="message">
            <br>
            <br>
            Login </span></strong></font>
        </td>
    </tr>                   
    <tr>
        <td colspan="2" class="label">&nbsp;</td>
    ...
    <tr>
        ...
        <td class="label" align="right" width="40%"><font size="3">Username</font>:</td>
        <td align="left" width="100%"><input type="text" name="username" maxlength="50"/></td>
    </tr>
    <tr>
        
        <td class="label" align="right"><font size="3">Password</font>:</td>
