...
// --></SCRIPT>
	...
	<!--<jsp:include page="SupplierOptions.jsp"/>		
	--><%} 
	else { %>
...
<center>
   ...
   <form method="" action="./AddCatBrandOffAction" name="" onSubmit="return validate()"> 
     ...
     <center>  <% if(request.getParameter("status")!=null)
                      ...
                      <%}%></center>
 <tr><td> Category Name</td><td><input type="text" name="cname"></td></tr> <br>
 <tr><td>  Category Desc</td><td><input type="text" name="cdesc"></td></tr><br>
   

   <tr><td><input type="submit" name="submit" value="Add Category"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br>
