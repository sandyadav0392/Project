...
<center>
 ...
 <tr><td> Stock Added Date</td><td><input type="text" name="stkaddate"></td></tr>
 <tr><td> Capacity</td><td><input type="text" name="capacity"></td></tr>
 <tr><td>  Stock Desc</td><td><input type="text" name="sdesc"></td></tr>
   

   <tr><td><input type="submit" name="submit" value="Add Stock"></td>
