...
<center>
    ...
    <tr> 
     ...
     <tr><td>Incharge Name</td><td><select name="inchrgname">
<option value="select">-Select-</option>
 <% CoreHash ch2=new EmpRegistrationDAO().getGeneralManager();
     ...
     <tr><td> <input type="submit" name="submit" value="Add Hotel"/><input type="reset" name="clear" value="Clear"/></td></tr><br/>
    </form>
    <script>

var frmvalidator  = new Validator("addhotel");
  frmvalidator.addValidation("hname","req","Please Enter Hostel Name");  
  frmvalidator.addValidation("hpltno","req","Please Enter Hostel Plot No");
  frmvalidator.addValidation("hstreet","req","Please Enter Hostel Street");
  frmvalidator.addValidation("city","req","Please Enter Hostel City");
  frmvalidator.addValidation("state","req","Please Enter Hostel State");  
  frmvalidator.addValidation("pin","req","Please Enter Hostel Pin Number");
  frmvalidator.addValidation("stdate","req","Please Enter Hostel Start Date");
  frmvalidator.addValidation("inchrgname","dontselect=0");
