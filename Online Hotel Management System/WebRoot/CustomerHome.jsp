...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<HEAD>
		...
		<SCRIPT src="images/scriptss.js" language="JavaScript"
...
// -->
		...
		<SCRIPT language="JavaScript" type="text/javascript"
			src="images/ScriptServlet"></SCRIPT>
...
function inDate() {
	...
	var date = new Date();
	document.addcomputer.rDate.value = date.getDate() + "-"
...
function offDate() {
	...
	if (years > 21) {
		document.register.doj.value = date.getDate() + "-"
				+ (date.getMonth() + 1) + "-" + date.getYear();
		;
	} else {
...
function goOn() {
	...
	window.location.href = 'http://' + host + ':' + port
			+ '/ADV/ChekUserAction?username=' + username;
...
// --></SCRIPT>
						...
						<DIV id="header">
							<IMG src="images/masthead2.jpg" alt="Telemarketing.com"
								width="1255" height="86" usemap="#masthead3856a44">
							<MAP name="masthead3856a44">
								<AREA shape="rect" coords="5,5,296,80" href="#"
									alt="Telemarketing.com">
							</MAP>

							<tr bgcolor="lightblue">
								<td height="30" colspan="6" class="navText style1"
									id="navigation">
							...
							<TR>
								<TD width="151" valign="top">
									<DIV id="navigation">
										...
										<A href="#" title="Call Centers" target="new"><IMG
												src="images/answernet_sm.jpg">
										</A>
										<P>
											...
											<tbody>
												<table align="center" width="400" border="0">
													...
													<center>
														...
														%>
														<strong><font color=black>Welcome
							...
							<TR>
								<TD colspan="2" style="vertical-align: bottom" align="center">
									<DIV id="footerBorder">
										...
										<DIV id="footer">
											«»
											<SPAN id="copyright">©2007-2009 AnswerNet</SPAN> «»
											<A href="#">Contact Us</A>
											<BR></BR>
											Visit AnswerNet
											<A href="#" title="Call Centers">Call Centers</A> for
											Customized
											<A href="#" title="Call Center Services">Call Center
												Services</A> and
											<A href="#" title="Answering Services">Answering Services</A>
										</DIV>
									</DIV>
