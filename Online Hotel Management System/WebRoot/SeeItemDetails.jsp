...
<center> 
   <form name="" action="./AddItemOrdrBookAction" method="">     
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">ITEM DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                int iid=Integer.parseInt(request.getParameter("itemid").trim());
                String loginname=(String)session.getAttribute("user"); 

       try{
      
       im=new ItemDAO().getPerticularItemDetails(iid);
         
          
         %> 
                  
        <tr>
    <input type="hidden" name="iid" value="<%=im.getItemid()%>"/>
     <td>Item Name </td>
    <td><input type="text"  name="iname"  value="<%=im.getItemname()%>" readonly /></td>
     </tr>
     
      <tr>
    <td>Item Type Name</td>
    <td><input type="text" name="itype" value="<%=im.getItemtypename()%>"  /></td>
    </tr>
          
      <tr>
    <td>Description</td>
    <td><input type="text" name="idesc" value="<%=im.getItemdesc()%>" /></td>
    </tr>
     
     <tr>
    <td>Cost/Unit</td>
    <td><input type="text" name="icost" value="<%=im.getCost4unit()%>"/></td>
    </tr>
   <tr>
    <td>Discount</td>
    <td><input type="text" name="idiscount" value="<%=im.getDiscnt()%>"/></td>
    </tr>
