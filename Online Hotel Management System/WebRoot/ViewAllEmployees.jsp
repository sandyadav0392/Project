...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">View Personal Profile</font></center></th>
      <tr rowspan="4"></tr>
 ...
 EmpModel  emodel=null;
      ...
      CoreHash ch=new EmpRegistrationDAO().getAllEmployeesProfiles(details);
    ...
    <td>Photo</td>    
       ...
       <table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="">
        ...
        while(em.hasMoreElements()){
             emodel=(EmpModel)em.nextElement();%>
             
             <tr>
             
 <td value="<%=emodel.getEmpid()%>"><a href="SeeEmployeePersonalProfileByAdmin.jsp?empid=<%=emodel.getEmpid()%>"><%=emodel.getFirstname() %></a></td>
 <td ><%=emodel.getDob()%></td>
 <td ><%=emodel.getDoj()%></td>
<%-- <td ><%=emodel.getAddress() %></td>--%>
<%-- <td value="<%=emodel.getQualid()%>"><%=emodel.getQualname() %></td>--%>
<%-- <td value="<%=emodel.getDeptid()%>"><%=emodel.getDeptname() %></td>--%>
<%-- <td value="<%=emodel.getDesgid()%>"><%=emodel.getDesgname() %></td>  --%>
  <td value="<%=emodel.getEmpinchargid() %>"><%=emodel.getEmpinchargname() %></td>           
  <td ><%=emodel.getEmailid() %></td>
   <td value="<%=emodel.getEmpid()%>.gif"><img src="userimages/<%=emodel.getEmpid()%>.gif" height=30 width=50></td>
