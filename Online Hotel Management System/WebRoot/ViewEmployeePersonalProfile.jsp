...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="#F4F5F7">
 ...
 EmpModel  emodel=null;
       ...
       emodel=new EmpRegistrationDAO().getEmployeesPersonalProfiles(details,loginname);
...
<%--    <td>Desg Name</td>--%>
    ...
    <td>Photo</td>    
        ...
        <tr>
 <td value="<%=emodel.getEmpid()%>"><a href="SeeEmployeePersonalProfile.jsp?empid=<%=emodel.getEmpid()%>"><%=emodel.getFirstname() %></a></td>
 <td ><%=emodel.getDob()%></td>
 <td ><%=emodel.getDoj()%></td>
