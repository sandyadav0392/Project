...
<%@page import="com.dts.project.dao.BookTypeDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">View All Booking Types</font></center></th>
      <tr rowspan="4"></tr>
  ...
  BookTypeModel  rmodel=null;

       try{
       
        String details=getServletContext().getRealPath("/userimages");
       CoreHash ch=new BookTypeDAO().getAllBookingTypes();
      ...
      report+="<tr rowspan='4'></tr>";
        ...
        if(request.getParameter("status")!=null)
           ...
           report+="<tr> <td>Bk.Type&nbsp;Name</td> <td>Cost/Hour</td> <td> Description</td><td> Status</td></tr> ";  
     
     
     
         %> 
         <strong>
 <table align="center" WIDTH="600" border="0" bordercolor="block" bgcolor=""> 
           <tr>
    <td>Bk.Type&nbsp;Name</td> 
    <td>Cost/Hour</td>    
    <td> Description</td>     
    <td> Status</td>
      ...
      <table align="center" WIDTH="690" border="0" bordercolor="black" bgcolor="">
        <% 
        
        while(em.hasMoreElements()){
             rmodel=(BookTypeModel)em.nextElement();
          
        
         report+="<tr>";
    report+="<td value="+rmodel.getBooktypeid()+">"+rmodel.getBooktypename()+"</td>";
   report+="<td >"+rmodel.getCostperHour()+"</td>";
   report+=" <td >"+rmodel.getBooktypedesc()+"</td>";  
   report+=" <td >"+rmodel.getBooktypestatus()+"</td> ";  
  report+=" </tr>";       
       session.setAttribute("Report",report);  
        ...
        <tr>
 <td value="<%=rmodel.getBooktypeid() %>"><a href="SeeBookTypeDetails.jsp?bktypeid=<%=rmodel.getBooktypeid()%>"><%=rmodel.getBooktypename() %></a></td>
  <td ><%=rmodel.getCostperHour() %></td>
   <td ><%=rmodel.getBooktypedesc() %></td>  
   <td ><%=rmodel.getBooktypestatus() %></td>   
  </tr>
  <%} %>
  </table>
