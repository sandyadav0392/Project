...
<center>
   ...
   <form name="custprofile" action="./ModifyCustPersonalDetailsAction" method="">     
<table align="center" WIDTH="500" border="1" bordercolor="black" bgcolor="">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white" >CUSTOMER  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       em=new CustomerDAO().getCustProfile(loginname);
         
          
         %> 
                  
    <tr><input type="hidden" name="custid" value="<%=em.getCustid()%>"/>
     <td>Cust Name </td>
     <td><input type="text"  name="cname"  value="<%=em.getCustfname()%>" readonly /></td>
    </tr>
    ...
    <td><input type="text" name="doj" value="<%=em.getDoj()%>" readonly /></td>
     ...
     <tr>
    <td>HNo</td>
    <td><input type="text" name="hno" value="<%=em.getCusthno()%>" /></td>
    </tr>
     
     <tr>
    <td>Street</td>
    <td><input type="text" name="street" value="<%=em.getStreet()%>" /></td>
    </tr>
    
     <tr>   
    <td>City</td>
    <td><input type="text" name="city" value="<%=em.getCity()%>"/></td>
    </tr>
    
    
      <tr>   
    <td>State</td>
    <td><input type="text" name="state" value="<%=em.getState()%>"/></td>
    </tr>
...
<option value="select">-select-</option>
   ...
   <tr>
    ...
    <tr>
    <td>Pin</td>
    <td><input type="text" name="pin" value="<%=em.getCustpin()%>"  /></td>
    </tr>
