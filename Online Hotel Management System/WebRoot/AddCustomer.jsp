...
<table>
<tbody>
 <table align="center" width="628" border="0" height="752">
<center>
	
	   <form method="" action="./AddCustomerAction" name="rigister" onSubmit="return validate()"> 
...
<tr><td>H.No</td><td><input type="text"    name="hno"></td></tr><br/> 
...
<tr><td>Pin </td><td><input type="text" name="pin"></td></tr><br/>
  ...
  frmvalidator.addValidation("photo","req","Please Enter PhotoGraph ");
			...
			<TR>
				<TD colspan="2" style="vertical-align: bottom" align="center">
					<DIV id="footerBorder">&nbsp;<DIV id="footer">«»<SPAN id="copyright">©2007-2019 AnswerNet</SPAN> «» <A href="#">Contact Us</A> <br/>
