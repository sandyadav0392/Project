...
<center>  <% if(request.getParameter("status")!=null)
					  {%>
                           <strong><font color=black>Welcome &nbsp;&nbsp;&nbsp;<%=request.getParameter("username")%></font></strong>
                      <%}%></center>
Contact Details
   </table>
</tbody>
			...
			<TR>
				<TD colspan="2" style="vertical-align: bottom" align="center">
					<DIV id="footerBorder">&nbsp;<DIV id="footer">«»<SPAN id="copyright">&Acirc;&copy;2007-2019 AnswerNet</SPAN> «» <A href="#">Contact Us</A> <BR></BR>
