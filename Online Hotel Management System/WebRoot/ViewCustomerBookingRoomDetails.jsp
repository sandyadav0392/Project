...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="lightgreen">
      <th colspan="15" bgcolor=""><center><b><font color="white">CUSTOMER BOOKING DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
BookTypeModel p=null;
       ...
       cust=new CustomerDAO().getCustProfile(lname);
             int cid=cust.getCustid(); 
      
      CoreHash ch=new BookTypeDAO().getCustBookingDetails(cid);
  ...
  <table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="">         
   ...
   <table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="">
       ...
       <tr>   
    <td value="<%=p.getBooktypeid()%>"><%=p.getBooktypename()%></td>
    <td value="<%=p.getRoomtypeid()%>"><%=p.getRoomtypename()%></td>
     <td><%=p.getNoofroomsforbook()%></td>
      <td value="<%=p.getCustid()%>"><%=p.getCustname()%></td>         
     <td><%=p.getRegdate()%></td>  
     <td><%=p.getBookfrmdate()%></td>   
     <td><%=p.getBooktodate()%></td>         
     <td><%=p.getTtbookamount()%></td>   
     <td><%=p.getBooktypestatus()%></td>    
