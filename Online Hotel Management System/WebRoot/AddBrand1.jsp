...
<center>
 ...
 <tr><td> Brand Name</td><td><input type="text" name="bname"></td></tr> 
 <tr><td>  Brand Desc</td><td><input type="text" name="bdesc"></td></tr>
   

   <tr><td><input type="submit" name="submit" value="Add Brand"></td>
