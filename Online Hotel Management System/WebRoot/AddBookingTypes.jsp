...
<center>
    <form  name="addbooktypes" action="./AddItemOrdrBookAction" method="" onSubmit="return validate()">
     ...
     <td><input type="text" name="bktypename" value=""></td>
     </tr><br/>
    ...
    <tr> 
     ...
     <tr><td> <input type="submit" name="submit" value="Add Book Types"/><input type="reset" name="clear" value="Clear"/></td></tr><br/>
    </form>
