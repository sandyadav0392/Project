...
-->
  ...
  <tr bgcolor="#a4c2c2">
	...
	<jsp:include page="GeneralOptions.html"/></td>
	
	</tr>
    <form method="" action="./AddGeneralUserRegisterAction" name="rigister" onSubmit="return validate()"> 
 ...
 <tr><td>  Middle Name</td><td><input type="text" name="middlename"></td></tr><br>
  ...
  <option value="1950">1950</option>
   ...
   <tr><td>Date Of Registration</td><td><select name="jday">
    <option value="00" selected>-:Day:-</option>
    <option value="01">01</option>
    <option value="02">02</option>
    <option value="03">03</option>
...
H.No <input type="text" name="hno"><br>
Street <input type="text" name="street"><br>
City/Town <input type="text" name="city"><br>


PIN<input type="text" name="pin"><br>
Phone No<input type="text" onBlur="ValidatePnoneNumber()" name="phno"><br>
Email-ID<input type="text" onBlur="checkMailId(rigister.emailid.value)" name="emailid"><br>
Photo <input type="file" name="photo"><br> 
Salary<input type="text" name="salary"><br>
<tr><td>Disgnation</td><td><select size="1" name="disgnation">
<option value="select">-Select-</option>
 <% CoreHash ch=new EmpRegistrationDAO().getDesigNamesOfUsers();
...
<tr><td>Department</td><td><select size="1" name="dname">
<option value="select">-Select-</option>
<% CoreHash ch1=new EmpRegistrationDAO().getUserDeptNames();
...
frmvalidator.addValidation("username","req","Please Enter User Name");
  ...
  frmvalidator.addValidation("hno","req","Please Enter Hno");
