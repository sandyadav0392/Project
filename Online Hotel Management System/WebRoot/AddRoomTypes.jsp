...
<%@page import="com.dts.project.model.FacilityModel"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<center>
 <form method="" action="./AddItemOrdrBookAction" name="" onSubmit="return validate()"> 
 ...
 <tr><td> Room Type Name</td><td><input type="text" name="rtname"></td></tr> 
 <tr><td>  Cost For Room</td><td><input type="text" name="cost"></td></tr>
   <tr><td>  No.Of. Rooms</td><td><input type="text" name="noofroom"></td></tr>
...
CoreHash ch2=new FacilityDAO().getFacilityTypes();
	           ...
	           FacilityModel p2=null;
	             while(em2.hasMoreElements()){
	                   p2=(FacilityModel)em2.nextElement();
	                    
	                   %>                    
                   <option  value="<%=p2.getFacilid()%>"><%=p2.getFacilname()%></option> 
                   <%}%>
</select>
    </td>
    </tr> 
 <tr><td>  Room Desc</td><td><input type="text" name="rdesc"></td></tr>      
        
   <tr><td><input type="submit" name="submit" value="Add Room Types"></td>
