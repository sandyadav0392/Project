...
<%@page import="com.dts.project.model.FacilityModel"%>
<%@page import="com.dts.project.dao.FacilityDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table align="center" WIDTH="630" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">View All Facilities</font></center></th>
      <tr rowspan="4"></tr>
  ...
  FacilityModel  fmodel=null;
       ...
       try{
        ...
        String details=getServletContext().getRealPath("/docu");
       CoreHash ch=new FacilityDAO().getAllFacilityDetails(details);
     ...
     String report="";
      ...
      report+="<tr rowspan='4'></tr>";
        ...
        if(request.getParameter("status")!=null)
           ...
           report+="<strong> <table align='center' WIDTH='650' border='0' bordercolor='block' bgcolor=''>   <tr>    <td>Facility Name</td>     <td>St.Date</td> <td>Aditional Charges</td>    <td>Status</td>     <td>Details</td>      </tr>     </table>  </strong>      <table align='center' WIDTH='650' border='0' bordercolor='black' bgcolor=''> "; 
    ...
    <td>Details</td> 
      ...
      <table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="">
        ...
        while(em.hasMoreElements()){
             fmodel=(FacilityModel)em.nextElement();
         report+="   <tr>";
 report+=" <td value="+fmodel.getFacilid()+">"+fmodel.getFacilname()+"</td>";
 report+="<td >"+fmodel.getStdate()+"</td>";

  report+="<td >"+fmodel.getAditionalchrg()+"</td>";
 report+="<td >"+fmodel.getFacilstatus()+"</td>";
   
 report+="<td><font color='#660000'><b><a href='docu/"+fmodel.getFacilid()+".doc'><font color='#660000'><b>"+fmodel.getFacilid()+".doc</b></font></a></b></font></td> ";
 report+="</tr>";
        ...
        <tr>
 <td value="<%=fmodel.getFacilid() %>"><a href="SeeFacilDetails.jsp?fid=<%=fmodel.getFacilid()%>"><%=fmodel.getFacilname() %></a></td>
  <td ><%=fmodel.getStdate() %></td>
<%--   <td ><%=fmodel.getEnddate() %></td>--%>
   <td ><%=fmodel.getAditionalchrg() %></td>
   <td ><%=fmodel.getFacilstatus() %></td>
   
   <td><font color="#660000"><b><a href="docu/<%=fmodel.getFacilid() %>.doc"><font color="#660000"><b><%=fmodel.getFacilid() %>.doc</b></font></a></b></font></td> 
  </tr>
  <%} %>
  </table>
