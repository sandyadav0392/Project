...
<html>
  <head>
    ...
    <title>My JSP 'ViewAllItems.jsp' starting page</title>
...
<center>
   ...
   <form name="" action="" method=""> 
    <span class="style13">Export to : <a href="ExportXLS" target="_blank"><font color="brown">XLS</font></a></span><br/>
            <br/>     
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="lightgreen">
      <th colspan="15" bgcolor=""><center><b><font color="white">ITEM  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %></strong> </span> 
       ...
       try{
        ...
        CoreHash ch=new ItemDAO().getAllItemDetails();
  ...
  report+="<tr rowspan='4'></tr>";
    ...
    if(request.getParameter("status")!=null)
       ...
       report+=" <strong> <table align='center' WIDTH='650' border='0' bordercolor='block' bgcolor=''>   <tr>     <td>Item Name </td>  <td>Item Type</td>     <td>Item Desc</td> <td>Item Cost</td>  <td>Discount</td> </tr></table></strong>       <table align='center' WIDTH='600' border='0' bordercolor='black' bgcolor=''>";
 ...
 <table align="center" WIDTH="650" border="0" bordercolor="block" bgcolor="">         
        ...
        <% while(em.hasMoreElements()){
             im=(ItemModel)em.nextElement();
             
             
             report+="<tr>";
             
             report+=" <td value="+im.getItemid()+">"+im.getItemname()+"</td>";             
             report+=" <td>"+im.getItemtypename()+"</td> "; 
             report+=" <td>"+im.getItemdesc()+"</td>"; 
             report+="<td>"+im.getCost4unit()+"</td>";   
            report+="<td>"+im.getDiscnt()+"</td>";              
          report+="</tr>";                      
...
%>     
    ...
    <td value="<%=im.getItemid()%>"><a href="SeeItemDetails.jsp?itemid=<%=im.getItemid()%>"><%=im.getItemname()%> </a></td>
    
    <td><%=im.getItemtypename()%></td>  
       <td><%=im.getItemdesc()%></td> 
             <td><%=im.getCost4unit()%></td>   
    <td><%=im.getDiscnt()%></td>   
...
<%--</center></td></tr>--%>
			...
			<TR>
				<TD colspan="3" style="vertical-align: bottom" align="center" WIDTH="700">
