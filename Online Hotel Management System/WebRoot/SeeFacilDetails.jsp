...
<center> 
   <form name="seefacildetails" action="./AddItemOrdrBookAction" method="">     
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="lightgreen"><center><b><font color="white">FACIL DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       fm=new FacilityDAO().getPerFacilityDetails(docu,fid);
         
          
         %> 
                  
        <tr>
    <input type="hidden" name="fclid" value="<%=fm.getFacilid()%>"/>
     <td>Facility Name </td>
    <td><input type="text"  name="fname"  value="<%=fm.getFacilname()%>" readonly /></td>
     </tr>
     
      <tr>
    <td>Start Date</td>
    <td><input type="text" name="stdate" value="<%=fm.getStdate()%>"  readonly/></td>
    </tr>
          
<%--      <tr>--%>
<%--    <td>End Date</td>--%>
<%--    <td><input type="text" name="edate" value="<%=fm.getEnddate()%>" /></td>--%>
<%--    </tr>--%>
     
     <tr>
    <td>Aditional Charges</td>
    <td><input type="text" name="charges" value="<%=fm.getAditionalchrg()%>"/></td>
    </tr>
    
    <tr>
    <td>Facility Details</td>
  <td><input type="file" name="fdtls" value="<%=fm.getFacilid() %>.doc"/></td>
...
<%--   <tr>--%>
<%--    <td>Status</td>--%>
<%--    <td><input type="text" name="status" value="<%=fm.getFacilstatus()%>"/></td>--%>
<%--    </tr>--%>
...
{e.printStackTrace();}%> 
  ...
  <%if(role.equalsIgnoreCase("Admin")){ %>
      <input type="submit" name="submit" value="Update Facility Details"/>
