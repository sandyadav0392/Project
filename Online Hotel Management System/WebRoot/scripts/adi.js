...
var form = document.register;
 ...
 document.register.phoneType.value=document.register.homephoneno.value
  document.register.phoneNo.value=document.register.homephonetype.value
...
else if(myValue=="office")
{
 ...
 document.register.state.value=document.register.officestate.value
  document.register.phoneNo.value=document.register.officephonetype.value
  document.register.phoneType.value=document.register.officephoneno.value
 ...
 else if(myValue=="personal")
{
 ...
 document.register.state.value=document.register.personalstate.value
  document.register.phoneNo.value=document.register.personalphonetype.value
  document.register.phoneType.value=document.register.personalphoneno.value
...
document.register.homelandmark.value+=document.register.landMark.value
	
 alert(document.register.landMark.value);
}
else if(myValue=="office")
{
...
document.register.officelandmark.value+=document.register.landMark.value
...
document.register.personallandmark.value+=document.register.landMark.value
 alert(document.register.landMark.value);
...
document.register.landMark.value= " ";
