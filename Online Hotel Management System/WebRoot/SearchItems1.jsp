...
// --></SCRIPT>
					...
					<DIV id="header">
	<IMG src="images/masthead2.jpg" alt="Telemarketing.com" width="800" height="86" usemap="#masthead3856a44"><MAP name="masthead3856a44"><AREA shape="rect" coords="5,5,296,80" href="#" alt="Telemarketing.com"></MAP>
...
<center>
 ...
 <form name="" action="AddCustOrderDetails.jsp" method="">     
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="lightgreen">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %></strong> </span> 
              ...
              int itemid=Integer.parseInt(request.getParameter("item").trim());
               // String loginname=(String)session.getAttribute("user"); 

      try{
      
        im1=new ItemDAO().getPerticularItemDetails(itemid);
            session.setAttribute("custordritm",im1);    
         %> 
 ...
 <table align="center" WIDTH="650" border="0" bordercolor="block" bgcolor="">         
  ...
  <tr>
    ...
    <td value="<%=im1.getItemid()%>" ><%=im1.getItemname()%></td>
    
    <td><%=im1.getItemtypename()%></td>  
    <td><%=im1.getItemdesc()%></td> 
    <td><%=im1.getCost4unit()%></td>   
    <td><%=im1.getDiscnt()%></td>   
