...
public class EmpInchargesRegistration extends HttpServlet {
...
String target="EmpGeneralManagersRegistrations.jsp?status=Invalid REgistration";
		...
		boolean flag=new EmpRegistrationDAO().addgeneralmanager(em);
if(flag)
	target="EmpGeneralManagersRegistrations.jsp?status=Employee Registration Is Successfully";
else
	target="EmpGeneralManagersRegistrations.jsp?status=Employee Registration Is Fail";
